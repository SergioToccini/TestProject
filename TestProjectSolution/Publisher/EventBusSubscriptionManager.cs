...
namespace Publisher
{
    public class EventBusSubscriptionManager : IEventBusSubscriptionsManager
    {
        ...
        public void AddStaticSubscription<T, TH>()
        ...
        public void RemoveStaticSubscription<T, TH>()
           where TH : IStaticIntegrationEventHandler<T>
           where T : PublisherEvent
        {
        ...
        public IEnumerable<SubscriptionInfo> GetHandlersForEvent<T>() where T : PublisherEvent
        {
        ...
        public bool HasSubscriptionsForEvent<T>() where T : PublisherEvent
        {
            var key = GetEventKey<T>();
